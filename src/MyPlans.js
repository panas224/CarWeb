...
class MyPlans extends Component{
    render() {
        return(
            <p>
                My future plans are:
                <li>Add prices for authos and make chance for people to assemble their own car, from details, which are available on the webb site</li>
                <li>Add VR images for all cars</li>
